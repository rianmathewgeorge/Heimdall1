...
export function plannerMessages(
  ...
  const system = [
    ...
    'If the task needs NO access at all (answering a question, explaining something),',
    'reply with "capabilities": []. An empty list is correct — never invent a',
    'capability to fill the list.',
